...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmdarcyfont.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lw.setText((Object)("Warning :  This is beta version!"+anywheresoftware.b4a.keywords.Common.CRLF+" Use at your own risk :)"));
...
mostCurrent._lb.setText((Object)("Brand Name : "+mostCurrent._ph.getManufacturer()+anywheresoftware.b4a.keywords.Common.CRLF+"Device Name : "+mostCurrent._ph.getModel()+anywheresoftware.b4a.keywords.Common.CRLF+"Android Version : "+mostCurrent._os+anywheresoftware.b4a.keywords.Common.CRLF+"Root Status : "+mostCurrent._rooot));
...
mostCurrent._b2.setText((Object)("Restore"));
...
mostCurrent._tlb.setText((Object)("Other [#Root]"));
 //BA.debugLineNum = 112;BA.debugLine="tlb.Color = Colors.rgb(103, 58, 183)";
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 179;BA.debugLine="File.Copy(File.DirAssets,\"Darcy.ttf\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Darcy.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
...
mostCurrent._lw = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Darc";
