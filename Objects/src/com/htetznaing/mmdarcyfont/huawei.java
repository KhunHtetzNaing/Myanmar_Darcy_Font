...
public class huawei extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.huawei");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.huawei");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmdarcyfont.huawei", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setText((Object)("Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Darcy Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._tlb.setText((Object)("Huawei"));
...
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 159;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
...
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Darcy.hwt");};
 //BA.debugLineNum = 123;BA.debugLine="File.Copy(File.DirAssets,\"Darcy.hwt\",File.DirRoot";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 154;BA.debugLine="Sub Interstitial_AdClosed";
 //BA.debugLineNum = 155;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
...
public static String  _menu_click() throws Exception{
 ...
 //BA.debugLineNum = 201;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 204;BA.debugLine="Sub share_Click";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 207;BA.debugLine="copy.setText(\"#MyanmarDarcyFont App! This is Beau";
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 210;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 185;BA.debugLine="copy.setText(\"#MyanmarDarcyFont App! This is Be";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarDarcyFont App! This is Beautiful Myanmar Zawgyi Font Style! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Darcy+Font");
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 188;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 193;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 194;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.Myanmar";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.MyanmarAndroidApp.com")));
 break; }
case 8: {
 //BA.debugLineNum = 196;BA.debugLine="StartActivity(About)";
