...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmdarcyfont.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"	Install ကိုနွိပ္ျပီး Myanmar Darcy(iF";
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 65;BA.debugLine="tlb.Text = \"Samsung\"";
mostCurrent._tlb.setText((Object)("Samsung"));
...
case 0: {
 //BA.debugLineNum = 178;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,samsung.getObject());
 break; }
case 1: {
 //BA.debugLineNum = 180;BA.debugLine="StartActivity(Oppo)";
