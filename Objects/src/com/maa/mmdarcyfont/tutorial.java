...
public class tutorial extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.tutorial");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.tutorial");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmdarcyfont.tutorial", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
int _height = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="wb.Initialize(\"wb\")";
mostCurrent._wb.Initialize(mostCurrent.activityBA,"wb");
 //BA.debugLineNum = 21;BA.debugLine="Activity.AddView(wb,0%x,0%y,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._wb.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 22;BA.debugLine="wb.LoadUrl(\"http://www.myanmarandroidapp.com/2017";
mostCurrent._wb.LoadUrl("http://www.myanmarandroidapp.com/2017/02/myanmar-font-styles.html");
 //BA.debugLineNum = 23;BA.debugLine="wv.setDisplayZoomControls(wb , False)";
mostCurrent._wv.setDisplayZoomControls((android.webkit.WebView)(mostCurrent._wb.getObject()),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 25;BA.debugLine="Banner.Initialize2(\"Banner\",\"ca-app-pub-417334857";
...
_height = 0;
 //BA.debugLineNum = 27;BA.debugLine="If GetDeviceLayoutValues.ApproximateScreenSize <";
if (anywheresoftware.b4a.keywords.Common.GetDeviceLayoutValues(mostCurrent.activityBA).getApproximateScreenSize()<6) { 
 //BA.debugLineNum = 29;BA.debugLine="If 100%x > 100%y Then height = 32dip Else height";
...
_height = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90));
 ...
 //BA.debugLineNum = 34;BA.debugLine="Activity.AddView(Banner, 0dip, 100%y - height, 10";
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 36;BA.debugLine="Log(Banner)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._banner));
 //BA.debugLineNum = 38;BA.debugLine="Activity.AddMenuItem(\"Open in Browser\",\"lb\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Open in Browser"),"lb");
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 14;BA.debugLine="Dim wb As WebView";
mostCurrent._wb = new anywheresoftware.b4a.objects.WebViewWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim wv As WebViewSettings";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 41;BA.debugLine="Sub lb_Click";
 //BA.debugLineNum = 42;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 43;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.myanmaran";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.myanmarandroidapp.com/2017/02/myanmar-font-styles.html")));
