...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmdarcyfont.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 23;BA.debugLine="lb.Text = \"	Install ကိုနွိပ္ျပီး Myanmar Darcy(iF";
...
mostCurrent._lb.setTypeface((android.graphics.Typeface)(mostCurrent._mm.getObject()));
 //BA.debugLineNum = 27;BA.debugLine="ph.SetScreenOrientation(1)";
mostCurrent._ph.SetScreenOrientation(processBA,(int) (1));
 //BA.debugLineNum = 28;BA.debugLine="Activity.Title = \"Samsung\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Samsung"));
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 69;BA.debugLine="Log(Interstitial)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._interstitial));
