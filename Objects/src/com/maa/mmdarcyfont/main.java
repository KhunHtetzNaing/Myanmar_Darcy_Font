...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmdarcyfont", "com.maa.mmdarcyfont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmdarcyfont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
int _height = 0;
 ...
 //BA.debugLineNum = 32;BA.debugLine="mm = mm.LoadFromAssets(\"darcy.ttf\")";
...
mostCurrent._b1.setText(BA.ObjectToCharSequence("Install"));
 //BA.debugLineNum = 48;BA.debugLine="Activity.AddView(b1,20%x,lb.Top+lb.Height+1%y,60%x";
...
mostCurrent._b2.setText(BA.ObjectToCharSequence("About"));
 //BA.debugLineNum = 52;BA.debugLine="Activity.AddView(b2,20%x,(b1.Top+b1.Height)+1%y,60";
...
mostCurrent._b3.setText(BA.ObjectToCharSequence("More App"));
 //BA.debugLineNum = 56;BA.debugLine="Activity.AddView(b3,20%x,b2.Top+b2.Height+1%y,60%x";
...
_copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 172;BA.debugLine="copy.setText(\"#MyanmarDarcyFont App! This is Beau";
_copy.setText(mostCurrent.activityBA,"#MyanmarDarcyFont App! This is Beautiful Myanmar Zawgyi Font Style! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Darcy+Font");
