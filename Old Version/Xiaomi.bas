...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Darcy.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Darcy.mtz")
	'	File.Copy(File.DirAssets,"Darcy.mtz",File.DirRootExternal & "/MIUI/theme","Darcy.mtz")
