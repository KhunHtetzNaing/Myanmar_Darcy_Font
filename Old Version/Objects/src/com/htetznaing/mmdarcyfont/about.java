...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmdarcyfont", "com.htetznaing.mmdarcyfont.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmdarcyfont.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 46;BA.debugLine="lblName.Text = \"Myanmar Darcy Font\"";
...
mostCurrent._lstone.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 61;BA.debugLine="lstOne.AddSingleLine2(\"App Name : Myanmar Darcy F";
...
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("Powered By : Myanmar Android Apps"),(Object)(5));
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 80;BA.debugLine="tlb.Text = \"Myanmar Darcy Font\"";
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Myanmar Darcy Font"));
 //BA.debugLineNum = 81;BA.debugLine="tlb.Color = Colors.rgb(103, 58, 183)";
...
mostCurrent._tlb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 83;BA.debugLine="tlb.TextSize = 25";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub t_Tick";
